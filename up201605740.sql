...
--
-- Host: localhost:3306
-- Tempo de geração: 23-Jan-2021 às 05:29
-- Versão do servidor: 10.1.47-MariaDB-0+deb9u1
-- versão do PHP: 7.2.34-9+0~20210112.53+debian9~1.gbpfdd1e6
...
('mind', '123', 'aca', 'healer', 'fitness', 0, 0);
