...
public class GameplayWizardHomeForm extends javax.swing.JFrame {
    ...
    private void dragonButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dragonButtonMouseClicked
        GameplayUserHomeForm.Location = "WizHome";
    ...
    private void wizSpecialMessageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_wizSpecialMessageMouseClicked
        ...
        if ( arr[0] == 0) wizSpeachWelcome.setText("<html>The dream is the precursor of everything!");
        if ( arr[0] == 1) wizSpeachWelcome.setText("<html>Heaven is where you'll be when you are okay right where you are.");
        if ( arr[0] == 2) wizSpeachWelcome.setText("<html>In some far off place, many light years in space, I’ll wait for you. Where human feet have never trod, where human eyes have never seen. I’ll build a world of abstract dreams and wait for you.");
        if ( arr[0] == 3) wizSpeachWelcome.setText("<html>The earth cannot move without music. The earth moves in a certain rhythm, a certain sound, a certain note. When the music stops the earth will stop and everything upon it will die");
        if ( arr[0] == 4) wizSpeachWelcome.setText("<html> Go to youtube and search for 'vidnaObmana* ‎– The River Of Appearance'. It is a brillint ambient album from 1996. ");
        
        wizBallonWelcome.setVisible(true);
        wizSpeachWelcome.setVisible(true);
        wizardSpecialMessageTimer(10000);
    }//GEN-LAST:event_wizSpecialMessageMouseClicked
    
    /**
     * auxiliar function to check if the atual special message is not equal to the last 
     * @param i
     * @return 
     */
