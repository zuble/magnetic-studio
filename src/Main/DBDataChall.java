...
public class DBDataChall extends DBCommunication{
    ...
    /**
     * sets a new challenge that is yet to be done by the user, that itsnt yet in his backpack
     */
    ...
    /**
     * gets the number of every challenge in DB 
     * @return 
     */
    ...
    /**
     * gets the database id of the challenge with inventory id = inventoryChallID
     * @param inventoryChallID
     * @return 
     */
    ...
    /**
     * gets the challenge infromation with the id = challID
     * @param challID
     * @return 
     */
    ...
    /**
     * inserts the atual chall in the user backpack
     */
    public void insertChallBackpack(){
        ...
        Logger.getLogger(Login.class.getName()).log(Level.SEVERE, null, ex);
        System.out.println("CHALL.INSERTCHALLBACKPACK ERROR");
        } 
    }
    
    /**
     * checks if the user has all challs in the atual quest done
     * @return 
     */
    public boolean allChallDone(){
        ...
        try {
            ...
            while( rs.next() ){
                if(rs.getInt(1) == 10){
                   aux=true;
                   System.out.println("ALL CHALL DONE");
                }
           }
        } catch (SQLException ex) {
        Logger.getLogger(Login.class.getName()).log(Level.SEVERE, null, ex);
        System.out.println("CHALL.ALLCHALLDONE ERROR");
        } 
        return aux;
    }
    
    /**
     * checks if the chall with id = challID is already in the user backpack
     * @param challID
     * @return 
     */
